...
const Eternal = () => {
  ...
  return (
    <div className="font-sans bg-[#f9f7f2] text-[#2f2f2f]">
      ...
      >
        <h1 className="text-5xl font-serif mb-4">Eternal Ruby Stud</h1>
        <div className="text-sm uppercase tracking-widest">
          <span className="mr-2 font-semibold">ALL</span>
          <span className="mx-1">✦</span>
          <span className="font-semibold">ETERNAL RUBY STUD</span>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto p-8 grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        {/* Product Info */}
        <div>
          <h2 className="text-3xl font-serif mb-2">Eternal Ruby Stud</h2>
