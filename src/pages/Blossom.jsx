...
const Blossom = () => {
  ...
  return (
    <div className="font-sans bg-[#f9f7f2] text-[#2f2f2f]">
      ...
      >
        <h1 className="text-5xl font-serif mb-4">Blossom Diamond Pendant</h1>
        <div className="text-sm uppercase tracking-widest">
          <span className="mr-2 font-semibold">ALL</span>
          <span className="mx-1">✦</span>
          <span className="font-semibold">BLOSSOM DIAMOND PENDANT</span>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto p-8 grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="flex gap-4">
          <div className="flex flex-col gap-4">
            <img
              src="/ban6.avif"
              className="border p-1 w-20 h-20 object-cover"
            />
            <img
              src="/ban8.avif"
              className="border p-1 w-20 h-20 object-cover"
        ...
        {/* Product Info */}
        <div>
          <h2 className="text-3xl font-serif mb-2">Blossom Diamond Pendant</h2>
          <p className="text-[#b45309] text-xl font-semibold mb-2">
            Rs. 6,200.00
          </p>
          <p className="text-sm text-red-600 font-medium mb-4">
            🔥 25 Items sold in last 23 hours
          </p>

          {/* Countdown */}
          <p className="font-semibold mb-2">Deal end soon</p>
          <div className="grid grid-cols-4 gap-2 mb-6">
            <div className="bg-[#3c2b2e] text-white p-2 text-center">
              170
              <br />
              Days
            </div>
          ...
          <button className="block w-full bg-[#c29b84] text-white py-3">
            BUY IT NOW
          </button>
      ...
      <div className="max-w-7xl mx-auto px-8 mt-12">
        <div className="border-b border-[#c29b84] mb-6">
          <div className="flex space-x-12 text-lg font-semibold cursor-pointer">
            {["DESCRIPTION", "ADDITIONAL INFORMATION", "REVIEWS"].map((tab) => (
              <div
                ...
                className={`pb-2 ${
                  activeTab === tab
                    ? "text-[#c29b84] border-b-2 border-[#c29b84]"
                    : "text-gray-600"
                }`}
              >
                {tab}
        ...
        {activeTab === "DESCRIPTION" && (
          <>
            <p className="text-sm text-gray-700 mb-6">
              The gold ornaments have a sentimental value from many generations.
              So wearing gold ornaments is a matter of pride and makes everyone
              feel comfortable. Gold carries the traditional value. This gold
              ornament is finely handcrafted in the hands of our expert
              Goldsmith. We have done the fine setting of the diamond on the
              gold.
            </p>
            <div className="text-sm text-gray-800 space-y-2">
              <p>
                <strong>Item Width:</strong> 6.37 cm
              </p>
              <p>
                <strong>Model No:</strong> AJYPI830690096
              </p>
              <p>
                <strong>Gross Weight:</strong> 12.108 grams
              </p>
              <p>
                <strong>Total metal weight:</strong> 10.66 grams
              </p>
              <p>
                <strong>Jewelry size:</strong> 2.6
              </p>
              <p>
                <strong>Gender:</strong> Women
              </p>
              <p>
                <strong>Certificate:</strong> BIS Certified
              </p>
              <p>
                <strong>Metal Purity:</strong> 916
              </p>
              <p>
                <strong>Metal:</strong> Yellow Gold
              </p>
              <p>
                <strong>Item Height:</strong> 10.12 Cm
              </p>
              <p>
                <strong>Country Of Origin:</strong> India
              </p>
              <p>
                <strong>Stone Weight:</strong> 0.54 grams
              </p>
              <p>
                <strong>Stone Type:</strong> Color Stone
              </p>
            </div>
          </>
        )}
        {activeTab === "ADDITIONAL INFORMATION" && (
          <>
            {/* Returns Policy */}
            <div className="max-w-4xl mx-auto px-6 py-12 text-[#2f2f2f]">
              <h2 className="text-4xl font-serif mb-6">Returns Policy</h2>
              ...
              {/* Shipping */}
              <h2 className="text-4xl font-serif mb-6">Shipping</h2>
              <p className="mb-4 text-base">
...
{activeTab === "REVIEWS" && (
      ...
      {/* Promo Banners */}
      <div className="max-w-7xl mx-auto mt-16 mb-7 grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
          {
            img: "/ban6.avif",
