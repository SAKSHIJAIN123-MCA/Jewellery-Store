...
const Blogread1 = () => {
  return (
    <div className="font-sans bg-[#f9f7f2]">
      ...
      {/* Main Blog Layout */}
      <div className="max-w-7xl mx-auto grid lg:grid-cols-3 px-4 md:px-6 gap-10 py-10 relative">
        {/* Left & Middle: Blog Content */}
        <div className="lg:col-span-2 space-y-10">
          ...
          />
          <h1 className="text-3xl md:text-4xl font-serif text-[#2f2f2f]">
          ...
          <div className="space-y-6 text-[#3c2b2e] text-base leading-7">
            <p>
              ...
              urna id volutpat lacus laoreet. Arcu bibendum at varius vel
              pharetra vel turpis nunc eget. Enim nec dui nunc mattis enim. Quam
              lacus suspendisse faucibus interdum posuere lorem ipsum. Urna
              cursus eget nunc scelerisque viverra mauris. Auctor eu augue ut
              lectus arcu bibendum at. Cursus turpis massa tincidunt dui ut.
            </p>
          </div>

          {/* Blockquote */}
          <div className="text-center text-[#3c2b2e] italic text-xl md:text-2xl font-medium leading-relaxed my-10">
            <FaQuoteLeft className="inline text-3xl text-[#cc886f] mr-2 align-top" />
            Fermentum Odio Eu Feugiat Pretium Nibh. Nulla At Volutpat Diam Ut
            Venenatis Tellus In. Sed Id Semper Risus In Hendrerit Gravida
            Rutrum. Pulvinar Sapien Ullamcorper Malesuada Proin. Risus In
            <FaQuoteRight className="inline text-3xl text-[#cc886f] ml-2 align-top" />
          </div>

          <p className="text-[#3c2b2e] text-base leading-7 mb-6">
            Fnim nec dui nunc mattis enim. Quam lacus suspendisse faucibus
            interdum posuere lorem ipsum. Urna cursus eget nunc scelerisque
            viverra mauris. Auctor eu augue ut lectus arcu bibendum at. Cursus
            turpis massa tincidunt dui ut. Egestas congue quisque egestas diam
            in arcu cursus euismod quis. Sed cras ornare arcu dui. Molestie nunc
            non blandit massa enim nec dui. Sed enim ut sem viverra aliquet eget
          ...
          <p className="text-[#3c2b2e] text-base leading-7">
            Sed cras ornare arcu dui. Molestie nunc non blandit massa enim nec
            dui. Sed enim ut sem viverra aliquet eget sit amet tellus. Iaculis
            urna id volutpat lacus laoreet. Arcu bibendum at varius vel pharetra
            vel turpis nunc eget. Enim nec dui nunc mattis enim. Quam lacus
            suspendisse faucibus interdum posuere lorem ipsum. Urna cursus eget
            nunc scelerisque viverra mauris. Auctor eu augue ut lectus arcu
            bibendum at.
          </p>
          {/* Italic Heading */}
          <h2 className="italic font-serif text-xl md:text-2xl text-[#2f2f2f] my-6">
            Eu Non Diam Phasellus Vestibulum Lorem. Habitant Morbi Tristique
            Senectus Et. Feugiat In Ante Metus Dictum.
          </h2>

          {/* Following Paragraph */}
          <p className="text-[#3c2b2e] text-base leading-7 mb-10">
            Urna cursus eget nunc scelerisque viverra mauris. Auctor eu augue ut
            lectus arcu bibendum at. Cursus turpis massa tincidunt dui ut.
            Egestas congue quisque egestas diam in arcu cursus euismod quis. Sed
            cras ornare arcu dui. Molestie nunc non blandit massa enim nec dui.
            Sed enim ut sem viverra aliquet eget sit amet tellus. Iaculis urna
            id volutpat lacus laoreet. Arcu bibendum at varius vel pharetra vel
            turpis nunc eget. Enim nec dui nunc mattis enim. Quam lacus
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-4">
            ...
            <div className="flex items-center space-x-3 text-[#cc886f] text-sm font-semibold">
              <span>Tags :</span>
              <button className="bg-[#3c2b2e] text-white px-3 py-1 rounded">
                Earrings
              </button>
              <button className="bg-[#3c2b2e] text-white px-3 py-1 rounded">
                Jewelry
          ...
          {/* Comment Section */}
          <h3 className="text-xl font-bold text-[#2f2f2f] mb-4">1 Comment</h3>
          <div className="border border-[#cc886f] p-4 md:p-6 rounded-md bg-white mb-10">
            <p className="text-[#3c2b2e] text-base leading-7 mb-4">
              Morbi leo urna molestie at. Quis enim lobortis scelerisque
              fermentum dui faucibus in ornare quam. Lacus vel facilisis
              volutpat est velit egestas dui. In hendrerit gravida rutrum
              quisque. Cursus in hac habitasse platea dictumst quisque sagittis.
          ...
          <div className="mt-16">
            ...
            <form className="space-y-6">
              ...
              <input
                type="text"
                placeholder="Name"
                className="w-full border border-[#cc886f] px-4 py-3 placeholder-[#bbb] focus:outline-none"
              />
              ...
              <div className="flex items-start space-x-2 text-sm text-[#3c2b2e]">
                <input
                  type="checkbox"
                  id="save-info"
                  className="mt-1 border-[#cc886f] text-[#cc886f]"
                />
              ...
              <button
                type="submit"
                className="relative inline-block bg-[#f7e1cd] text-[#2f2f2f] font-semibold px-6 py-3 border border-[#f7e1cd] hover:bg-[#f2d3b7] transition"
              >
                SUBMIT NOW
              </button>
            </form>
            ...
            {/* Navigation Links */}
            <div className="flex justify-between items-center mt-16 text-sm font-semibold text-[#2f2f2f]">
              <div className="flex items-center space-x-2 cursor-pointer">
                <span className="border border-[#cc886f] rounded-full p-1">
                  ←
                </span>
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-8">
            ...
            <ul className="space-y-3">
              {["Bracelets", "Earrings", "Pendants"].map((item) => (
                <li
                  key={item}
                  className="flex justify-between items-center text-[#2f2f2f] text-[15px] font-medium"
                >
                  {item}
          ...
          {/* Recent Posts */}
          <div>
            <h3 className="text-xl font-bold text-[#cc886f] mb-15">
              Recent posts
            </h3>
            {[
              {
              ...
              <div key={i} className="flex items-start mb-6">
                ...
                <div>
                  ...
                  <p className="font-semibold text-[#2f2f2f] text-sm mb-1">
                    {post.title}
                  </p>
...
<div className="mb-17"> 
  ...
  <div className="flex flex-wrap gap-3">
    {["Earrings", "Jewelry", "Rings"].map((tag) => (
      <button
        key={tag}
        className="bg-[#3c2b2e] text-white px-4 py-2 rounded-md text-sm font-semibold"
      >
        {tag}
      </button>
    ))}
...
<div className="relative w-full mb-15">
  ...
  <div className="absolute inset-0 px-5 py-8 text-white flex flex-col justify-between">
    <div>
      ...
      <p className="text-[#0a0909] font-semibold mt-4">
        Pay 10 & Get 1 free = 11/Mon
      </p>
    </div>
    <button className="bg-[#f2e4d7] text-[#2f2f2f] px-6 py-3 text-sm font-medium shadow border border-[#f2e4d7] hover:shadow-md transition">
      SHOP NOW
    </button>
  </div>
</div>
